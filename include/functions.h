...
f32 fabsf(f32 f);
// I'd rather have a define that says it's IDO but self will work for now.
#ifdef __GNUC__
...
void func_8008F470(GlobalContext* globalCtx, void** skeleton, Vec3s* jointTable, s32 dListCount, s32 lod, s32 tunic,
                   s32 boots, s32 face, OverrideLimbDrawOpa overrideLimbDraw, PostLimbDrawOpa postLimbDraw, void* self);
...
void TransitionUnk_Draw(TransitionUnk* self, Gfx**);
void func_800B23E8(TransitionUnk* self);
void TransitionTriforce_Start(void* self);
void* TransitionTriforce_Init(void* self);
void TransitionTriforce_Destroy(void* self);
void TransitionTriforce_Update(void* self, s32 updateRate);
void TransitionTriforce_SetColor(void* self, u32 color);
void TransitionTriforce_SetType(void* self, s32 type);
void TransitionTriforce_Draw(void* self, Gfx** gfxP);
s32 TransitionTriforce_IsDone(void* self);
void TransitionWipe_Start(void* self);
void* TransitionWipe_Init(void* self);
void TransitionWipe_Destroy(void* self);
void TransitionWipe_Update(void* self, s32 updateRate);
void TransitionWipe_Draw(void* self, Gfx** gfxP);
s32 TransitionWipe_IsDone(void* self);
void TransitionWipe_SetType(void* self, s32 type);
void TransitionWipe_SetColor(void* self, u32 color);
...
void TransitionFade_Start(void* self);
void* TransitionFade_Init(void* self);
void TransitionFade_Destroy(void* self);
void TransitionFade_Update(void* self, s32 updateRate);
void TransitionFade_Draw(void* self, Gfx** gfxP);
s32 TransitionFade_IsDone(void* self);
void TransitionFade_SetColor(void* self, u32 color);
void TransitionFade_SetType(void* self, s32 type);
...
void func_800C55D0(GameAlloc* self);
