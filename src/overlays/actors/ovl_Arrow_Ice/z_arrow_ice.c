...
void ArrowIce_Charge(ArrowIce* self, GlobalContext* globalCtx);
void ArrowIce_Fly(ArrowIce* self, GlobalContext* globalCtx);
void ArrowIce_Hit(ArrowIce* self, GlobalContext* globalCtx);
...
void ArrowIce_SetupAction(ArrowIce* self, ArrowIceActionFunc actionFunc) {
...
void ArrowIce_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    self->radius = 0;
    self->unk_160 = 1.0f;
    ArrowIce_SetupAction(self, ArrowIce_Charge);
...
void ArrowIce_Charge(ArrowIce* self, GlobalContext* globalCtx) {
    ...
    func_8002F974(&self->actor, NA_SE_PL_ARROW_CHARGE_ICE - SFX_FLAG);

    // if arrow has no parent, player has fired the arrow
    if (arrow->actor.parent == NULL) {
        self->unkPos = self->actor.world.pos;
        self->radius = 10;
        ArrowIce_SetupAction(self, ArrowIce_Fly);
        self->alpha = 255;
    }
}
...
void ArrowIce_Fly(ArrowIce* self, GlobalContext* globalCtx) {
    ...
    func_80867E8C(&self->unkPos, &self->actor.world.pos, 0.05f);

    if (arrow->hitFlags & 1) {
        Audio_PlayActorSound2(&self->actor, NA_SE_IT_EXPLOSION_ICE);
        ArrowIce_SetupAction(self, ArrowIce_Hit);
        self->timer = 32;
        self->alpha = 255;
...
void ArrowIce_Draw(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if ((arrow != NULL) && (arrow->actor.update != NULL) && (self->timer < 255)) {
        ...
        if (self->unk_164 > 0) {
            ...
            gDPSetPrimColor(POLY_XLU_DISP++, 0, 0, 0, (s32)(10.0f * self->unk_164) & 0xFF,
                            (s32)(50.0f * self->unk_164) & 0xFF, (s32)(150.0f * self->unk_164) & 0xFF);
        ...
        Matrix_Scale(self->radius * 0.2f, self->unk_160 * 3.0f, self->radius * 0.2f, MTXMODE_APPLY);
