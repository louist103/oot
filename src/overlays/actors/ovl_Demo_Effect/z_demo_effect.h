...
// These names come from the objects that correspond to self actor type.
typedef enum {
    ...
    /* 0x16 */ DEMO_EFFECT_DUST, // Object is jewel, but self is really the dust in the ToT light arrow cutscene.
