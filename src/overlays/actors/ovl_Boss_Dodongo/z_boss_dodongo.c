...
s32 func_808C18B0(BossDodongo* this, GlobalContext* globalCtx) { // Eat Explosive
    ...
    while (currentExplosive != NULL) {
        ...
        GfxPrint_Printf(printer, "Mouth XYZ %.2f %.2f %.2f ", this->unk_41C.x, this->unk_41C.y, this->unk_41C.z);
        GfxPrint_SetPos(printer, 0, 9);
        GfxPrint_Printf(printer, "Bomb XYZ  %.2f %.2f %.2f ", currentExplosive->posRot.pos.x,
                        currentExplosive->posRot.pos.y, currentExplosive->posRot.pos.z);
        ...
        GfxPrint_Printf(printer, "Dist from %.2f %.2f %.2f ", dx, dy, dz);
...
// Spawn bomb explode effect //Also take bomb damage
void func_808C2C78(BossDodongo* this, GlobalContext* globalCtx) {
...
void BossDodongo_Update(Actor* thisx, GlobalContext* globalCtx) {
    ...
    GfxPrint_Printf(printer, "this->unk_19C = %d", this->unk_19C);
    GfxPrint_SetPos(printer, 0, 1);
    GfxPrint_Printf(printer, "this->unk_196 = %d", this->unk_196);
    GfxPrint_SetPos(printer, 0, 2);
    GfxPrint_Printf(printer, "this->unk_198 = %d", this->unk_198);
    GfxPrint_SetPos(printer, 0, 3);
    GfxPrint_Printf(printer, "this->unk_19A = %d", this->unk_19A);
    GfxPrint_SetPos(printer, 0, 4);
    GfxPrint_Printf(printer, "this->unk_204 = %.2f", this->unk_204);
    GfxPrint_SetPos(printer, 0, 5);
    GfxPrint_Printf(printer, "this->unk_3EC XYZ = %.2f %.2f %.2f", this->unk_3EC.z, this->unk_3EC.y, this->unk_3EC.z);
    ...
    if (this->unk_1C8 != 0) {
        ...
        if ((globalCtx->envCtx.unk_8C[1][2] == 0) && (globalCtx->envCtx.unk_8C[0][2] == 0)) {
            ...
            globalCtx2->envCtx.unk_8C[0][0] = (u8)this->unk_240;
            globalCtx2->envCtx.unk_8C[0][1] = (u8)(this->unk_240 * 0.1f);
        }
    }
    ...
    if (this->unk_1BE != 0) {
        ...
        Math_SmoothScaleMaxMinF(&this->fogR, globalCtx2->lightCtx.unk_07, 1, 5.0f, 0.0);
        Math_SmoothScaleMaxMinF(&this->fogG, globalCtx2->lightCtx.unk_08, 1.0f, 5.0f, 0.0);
        Math_SmoothScaleMaxMinF(&this->fogB, globalCtx2->lightCtx.unk_09, 1.0f, 5.0f, 0.0);
    ...
    if (player->actor.posRot.pos.y < (-1000.0f)) {
        ...
        if ((this->unk_19E & sp90) == 0) {
            ...
            sp54.x = sinf(temp_f12_2) * sp50 + (-890.0f);
            sp54.y = -1523.76f;
            ...
            for (i1 = 0; i1 < 4; i1++) {
                ...
                func_808C17C8(globalCtx, &sp54, &sp6C, &sp60, ((s16)Math_Rand_ZeroFloat(2.0f)) + 6, 80);
            }
        }
