...
// This is the parameter of self actor,
 ...
 * DEMO_DU_CS_FIREMEDALLION: I couldn't find how to trigger self one from the map selector, but you can go to Map 78 and beat Volvagia (or use the gameshark 8015E98B 0002 so the game thinks you already has beaten it).
