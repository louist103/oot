...
void func_80A70E34(EnHy* self, GlobalContext* globalCtx);
void func_80A7134C(EnHy* self, GlobalContext* globalCtx);
void func_80A71530(EnHy* self, GlobalContext* globalCtx);
void func_80A711B4(EnHy* self, GlobalContext* globalCtx);
void func_80A712C0(EnHy* self, GlobalContext* globalCtx);
void func_80A710F8(EnHy* self, GlobalContext* globalCtx);
void func_80A7127C(EnHy* self, GlobalContext* globalCtx);
void func_80A712B4(EnHy* self, GlobalContext* globalCtx);
void func_80A714C4(EnHy* self, GlobalContext* globalCtx);
...
s32 func_80A6F5B0(EnHy* self, GlobalContext* globalCtx) {
    u8 i2 = D_80A722D8[self->actor.params & 0x7F].unk_0;
    u8 i1 = D_80A722D8[self->actor.params & 0x7F].unk_1;
    u8 i0 = D_80A722D8[self->actor.params & 0x7F].unk_6;

    self->unk_198 = Object_GetIndex(&globalCtx->objectCtx, D_80A72010[i0].objectId);
    if (self->unk_198 < 0) {
        return false;
    }

    self->unk_197 = Object_GetIndex(&globalCtx->objectCtx, D_80A72010[i1].objectId);
    if (self->unk_197 < 0) {
        return false;
    }

    self->unk_196 = Object_GetIndex(&globalCtx->objectCtx, D_80A71F50[i2].objectId);
    if (self->unk_196 < 0) {
        return false;
    }
...
s32 func_80A6F6C0(EnHy* self, GlobalContext* globalCtx) {
    if (!Object_IsLoaded(&globalCtx->objectCtx, self->unk_198)) {
        return false;
    }

    if (!Object_IsLoaded(&globalCtx->objectCtx, self->unk_197)) {
        return false;
    }

    if (!Object_IsLoaded(&globalCtx->objectCtx, self->unk_196)) {
        return false;
    }
...
s32 func_80A6F744(EnHy* self, GlobalContext* globalCtx) {
    self->unk_199 = Object_GetIndex(&globalCtx->objectCtx, OBJECT_OS_ANIME);
    if (self->unk_199 < 0) {
        return false;
    }
...
s32 func_80A6F790(EnHy* self, GlobalContext* globalCtx) {
    if (!Object_IsLoaded(&globalCtx->objectCtx, self->unk_199)) {
        return false;
    }
...
void func_80A6F7CC(EnHy* self, GlobalContext* globalCtx, s32 getItemId) {
    self->unk_260 = getItemId;
...
u16 func_80A6F810(GlobalContext* globalCtx, Actor* thisx) {
    ...
    EnHy* self = THIS;
    u16 textId = Text_GetFaceReaction(globalCtx, (self->actor.params & 0x7F) + 37);

    if (textId != 0) {
        if ((self->actor.params & 0x7F) == 5) {
            player->exchangeItemId = EXCH_ITEM_BLUE_FIRE;
        }
        return textId;
    }

    switch (self->actor.params & 0x7F) {
        case 0:
            if (globalCtx->sceneNum == SCENE_KAKARIKO) {
                return (self->unk_330 & 0x800) ? 0x508D : ((gSaveContext.infTable[12] & 0x800) ? 0x508C : 0x508B);
        ...
        case 18:
            if (!LINK_IS_ADULT) {
                ...
                return (self->unk_330 & 0x800) ? 0x5062 : ((gSaveContext.infTable[22] & 0x10) ? 0x5061 : 0x5060);
            }
        case 19:
            return 0x7120;
        case 20:
    ...
    switch (func_8010BDBC(&globalCtx->msgCtx)) {
        ...
        case 3:
            switch (self->actor.textId) {
                ...
                case 0x709F:
                    if (!self->unk_215) {
                        Audio_PlaySoundGeneral(self->actor.textId == 0x709F ? NA_SE_SY_CORRECT_CHIME : NA_SE_SY_ERROR,
                ...
                case 0x70F2:
                case 0x70F3:
                    if (self->skelAnime.animation != &gObjOsAnim_33B4) {
                        func_80034EC0(&self->skelAnime, D_80A72050, 23);
                        func_800F5C64(0x922);
                    }
                    break;
            }
        ...
        case 2:
            switch (self->actor.textId) {
                ...
                case 0x70F2:
                case 0x70F3:
                    Rupees_ChangeBy(beggarRewards[self->actor.textId - 0x70F0]);
                    func_80034EC0(&self->skelAnime, D_80A72050, 17);
                ...
                case 0x709E:
                    ...
                    break;
                case 0x709F:
                    func_80A6F7CC(self, globalCtx, (gSaveContext.infTable[25] & 2) ? GI_RUPEE_BLUE : GI_HEART_PIECE);
                    self->actionFunc = func_80A714C4;
                    break;
            }
            return 0;
        case 5:
...
void func_80A705A4(EnHy* self) {
    u8 i;

    if (DECR(self->unk_21A) == 0) {
        i = D_80A722D8[self->actor.params & 0x7F].unk_0;
        self->unk_218++;
        if ((D_80A71F50[i].unk_8 != NULL) && (D_80A71F50[i].unk_8[self->unk_218] == NULL)) {
            self->unk_21A = Rand_S16Offset(30, 30);
            self->unk_218 = 0;
        }
    }
}

void func_80A70660(EnHy* self) {
    u8 i = self->actor.params & 0x7F;

    self->collider.dim.radius = D_80A723D4[i].radius;
    self->collider.dim.height = D_80A723D4[i].height;
}

void func_80A70698(EnHy* self) {
    u8 i = self->actor.params & 0x7F;

    self->actor.shape.shadowScale = D_80A725A4[i].unk_0;
    Actor_SetScale(&self->actor, D_80A725A4[i].unk_10);
    self->actor.targetMode = D_80A725A4[i].unk_14;
    self->unk_264 = D_80A725A4[i].unk_4;
    self->unk_25C = D_80A725A4[i].unk_18;
    self->unk_25C += self->collider.dim.radius;
}

void func_80A70734(EnHy* self, GlobalContext* globalCtx) {
    Vec3s pos;

    pos.x = self->actor.world.pos.x;
    pos.y = self->actor.world.pos.y;
    pos.z = self->actor.world.pos.z;
    pos.x += D_80A723D4[self->actor.params & 0x7F].offset.x;
    pos.y += D_80A723D4[self->actor.params & 0x7F].offset.y;
    pos.z += D_80A723D4[self->actor.params & 0x7F].offset.z;
    self->collider.dim.pos = pos;
    CollisionCheck_SetOC(globalCtx, &globalCtx->colChkCtx, &self->collider.base);
}

void func_80A70834(EnHy* self, GlobalContext* globalCtx) {
    Player* player = GET_PLAYER(globalCtx);
        ...
        if (!Inventory_HasSpecificBottle(ITEM_BLUE_FIRE) && !Inventory_HasSpecificBottle(ITEM_BUG) &&
            ...
            switch (func_8002F368(globalCtx)) {
                ...
                case EXCH_ITEM_LETTER_RUTO:
                    self->actor.textId = 0x70EF;
                    break;
                default:
                    if (Player_GetMask(globalCtx) == PLAYER_MASK_NONE) {
                        self->actor.textId = 0x70ED;
                    }
                    break;
            }
        } else {
            switch (func_8002F368(globalCtx)) {
                case EXCH_ITEM_BLUE_FIRE:
                    self->actor.textId = 0x70F0;
                    break;
                case EXCH_ITEM_FISH:
                    self->actor.textId = 0x70F1;
                    break;
                case EXCH_ITEM_BUG:
                    self->actor.textId = 0x70F2;
                    break;
                default:
                    if (Player_GetMask(globalCtx) == PLAYER_MASK_NONE) {
                        self->actor.textId = 0x700C;
                    }
                    break;
            }
        }
...
void func_80A70978(EnHy* self, GlobalContext* globalCtx) {
    Player* player = GET_PLAYER(globalCtx);
    s16 phi_a3;
    ...
    switch (self->actor.params & 0x7F) {
        ...
        case 9:
        case 10:
            phi_a3 = (self->unk_1E8.unk_00 == 0) ? 1 : 2;
            break;
        case 12:
            phi_a3 = 1;
            break;
        ...
        case 0:
        case 18:
            phi_a3 = (self->unk_1E8.unk_00 == 0) ? 2 : 4;
            break;
        default:
            phi_a3 = 2;
            break;
    ...
    if (LINK_IS_ADULT) {
        self->unk_1E8.unk_14 = D_80A724A8[self->actor.params & 0x7F].unk_8;
    } else {
        self->unk_1E8.unk_14 = D_80A724A8[self->actor.params & 0x7F].unk_4;
    }

    func_80034A14(&self->actor, &self->unk_1E8, D_80A724A8[self->actor.params & 0x7F].unk_0, phi_a3);

    if (func_800343CC(globalCtx, &self->actor, &self->unk_1E8.unk_00, self->unk_25C, func_80A6F810, func_80A70058)) {
        func_80A70834(self, globalCtx);
    }
}

s32 func_80A70AE4(EnHy* self, GlobalContext* globalCtx) {
    switch (globalCtx->sceneNum) {
        case SCENE_SPOT01:
            if (((self->actor.params & 0x7F) != 9) && ((self->actor.params & 0x7F) != 10) &&
                ((self->actor.params & 0x7F) != 12) && ((self->actor.params & 0x7F) != 2) &&
                ((self->actor.params & 0x7F) != 7)) {
                return true;
            } else if (!LINK_IS_ADULT) {
                return true;
            } else if (((self->actor.params & 0x7F) != 12) && IS_NIGHT) {
                return false;
            } else {
                return true;
            }
        case SCENE_LABO:
            if ((self->actor.params & 0x7F) != 10) {
                return true;
            } else if (LINK_IS_CHILD) {
                return false;
            } else if (((self->actor.params & 0x7F) == 10) && !gSaveContext.nightFlag) {
                return false;
            } else {
                return true;
            }
        case SCENE_IMPA:
            if ((self->actor.params & 0x7F) != 0) {
                return true;
            } else if (!gSaveContext.nightFlag) {
                return false;
            } else {
        ...
        case SCENE_KAKARIKO:
            ...
            } else if (((self->actor.params & 0x7F) != 9) && ((self->actor.params & 0x7F) != 2) &&
                       ((self->actor.params & 0x7F) != 7)) {
                return true;
            } else if (!gSaveContext.nightFlag) {
                return false;
...
void EnHy_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (((self->actor.params & 0x7F) > 20) || !func_80A6F744(self, globalCtx) || !func_80A6F5B0(self, globalCtx)) {
        Actor_Kill(&self->actor);
    }

    if (!func_80A70AE4(self, globalCtx)) {
        Actor_Kill(&self->actor);
    }

    self->actionFunc = func_80A70E34;
}
...
void func_80A70E34(EnHy* self, GlobalContext* globalCtx) {
    if (func_80A6F790(self, globalCtx) && func_80A6F6C0(self, globalCtx)) {
        self->actor.objBankIndex = self->unk_198;
        gSegments[6] = VIRTUAL_TO_PHYSICAL(globalCtx->objectCtx.status[self->actor.objBankIndex].segment);
        SkelAnime_InitFlex(globalCtx, &self->skelAnime, D_80A72010[D_80A722D8[self->actor.params & 0x7F].unk_6].unk_4,
                           NULL, self->jointTable, self->morphTable, 16);
        ActorShape_Init(&self->actor.shape, 0.0f, ActorShadow_DrawCircle, 0.0f);
        gSegments[6] = VIRTUAL_TO_PHYSICAL(globalCtx->objectCtx.status[self->unk_199].segment);
        Collider_InitCylinder(globalCtx, &self->collider);
        Collider_SetCylinder(globalCtx, &self->collider, &self->actor, &D_80A71EC0);
        func_80A70660(self);
        CollisionCheck_SetInfo2(&self->actor.colChkInfo, NULL, &D_80A71EEC);
        func_80034EC0(&self->skelAnime, D_80A72050, D_80A722D8[self->actor.params & 0x7F].unk_B);

        if ((globalCtx->sceneNum == SCENE_MARKET_ALLEY) || (globalCtx->sceneNum == SCENE_MARKET_DAY)) {
            self->actor.flags &= ~0x10;
            self->actor.uncullZoneScale = 0.0f;
        }

        if (globalCtx->sceneNum == SCENE_KAKARIKO) {
            self->unk_330 = gSaveContext.eventChkInf[6];
        }

        func_80A70698(self);
        self->path = Path_GetByIndex(globalCtx, (self->actor.params & 0x780) >> 7, 15);
        ...
        switch (self->actor.params & 0x7F) {
            case 3:
                ...
                self->actionFunc = func_80A711B4;
                break;
            case 7:
                self->unk_195 = false;
                self->actionFunc = func_80A712C0;
                break;
            case 0:
                if (globalCtx->sceneNum == SCENE_MARKET_DAY) {
                    self->actionFunc = func_80A710F8;
                    break;
                }
            case 1:
            case 2:
...
void func_80A710F8(EnHy* self, GlobalContext* globalCtx) {
    if (self->unk_1E8.unk_00 != 0) {
        if (self->skelAnime.animation != &gObjOsAnim_0BFC) {
            func_80034EC0(&self->skelAnime, D_80A72050, 26);
        }
    } else if (gSaveContext.eventInf[3] & 1) {
        if (self->skelAnime.animation != &gObjOsAnim_0FE4) {
            func_80034EC0(&self->skelAnime, D_80A72050, 25);
        }
    } else if (self->skelAnime.animation != &gObjOsAnim_12E8) {
        func_80034EC0(&self->skelAnime, D_80A72050, 24);
    }
}
...
void func_80A711B4(EnHy* self, GlobalContext* globalCtx) {
    ...
    distSq = Path_OrientAndGetDistSq(&self->actor, self->path, self->unk_214, &yaw);
    ...
    if ((distSq > 0.0f) && (distSq < 1000.0f)) {
        self->unk_214++;
        if (self->unk_214 > (self->path->count - 1)) {
            self->unk_214 = 0;
        }
    }
}
...
void func_80A7127C(EnHy* self, GlobalContext* globalCtx) {
    func_80034F54(globalCtx, self->unk_21C, self->unk_23C, 16);
}
...
void func_80A712C0(EnHy* self, GlobalContext* globalCtx) {
    if ((self->actor.xzDistToPlayer <= 100.0f) && (self->path != NULL)) {
        func_80034EC0(&self->skelAnime, D_80A72050, 7);
        self->actor.speedXZ = 0.4f;
        self->actionFunc = func_80A7134C;
    }
...
void func_80A7134C(EnHy* self, GlobalContext* globalCtx) {
    ...
    if ((self->skelAnime.animation == &gObjOsAnim_2160) && (self->unk_1E8.unk_00 != 0)) {
        func_80034EC0(&self->skelAnime, D_80A72050, 8);
    }

    if ((self->skelAnime.animation == &gObjOsAnim_265C) && (self->unk_1E8.unk_00 == 0)) {
        func_80034EC0(&self->skelAnime, D_80A72050, 7);
    }
    ...
    if (!(distSq <= 0.0f) && !(distSq >= 1000.0f)) {
        if (!self->unk_195) {
            ...
            if (self->unk_214 > (self->path->count - 1)) {
                self->unk_195 = true;
                self->unk_214 = self->path->count - 2;
            }
        } else {
            self->unk_214--;
            if (self->unk_214 < 0) {
...
void func_80A714C4(EnHy* self, GlobalContext* globalCtx) {
    if (Actor_HasParent(&self->actor, globalCtx)) {
        self->actionFunc = func_80A71530;
    } else {
        func_8002F434(&self->actor, globalCtx, self->unk_260, self->actor.xzDistToPlayer + 1.0f,
                      fabsf(self->actor.yDistToPlayer) + 1.0f);
    }
}
...
void EnHy_Update(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (self->actionFunc != func_80A70E34) {
        gSegments[6] = VIRTUAL_TO_PHYSICAL(globalCtx->objectCtx.status[self->unk_199].segment);
    ...
    func_80A70978(self, globalCtx);
    func_80A70734(self, globalCtx);
}
...
s32 func_80A716B8(GlobalContext* globalCtx, s32 limbIndex, Gfx** dList, Vec3f* pos, Vec3s* rot, void* thisx) {
    ...
    if (limbIndex == 15) {
        gSPSegment(POLY_OPA_DISP++, 0x06, globalCtx->objectCtx.status[self->unk_196].segment);
        gSegments[6] = VIRTUAL_TO_PHYSICAL(globalCtx->objectCtx.status[self->unk_196].segment);
        i = D_80A722D8[self->actor.params & 0x7F].unk_0;
        *dList = D_80A71F50[i].dList;

        if (D_80A71F50[i].unk_8 != NULL) {
            ptr = D_80A71F50[i].unk_8[self->unk_218];
            gSPSegment(POLY_OPA_DISP++, 0x0A, SEGMENTED_TO_VIRTUAL(ptr));
        }

        gSegments[6] = VIRTUAL_TO_PHYSICAL(globalCtx->objectCtx.status[self->unk_198].segment);
    }

    if (limbIndex == 15) {
        Matrix_Translate(1400.0f, 0.0f, 0.0f, MTXMODE_APPLY);
        sp48 = self->unk_1E8.unk_08;
    ...
    if (limbIndex == 8) {
        sp48 = self->unk_1E8.unk_0E;
        Matrix_RotateX((-sp48.y / (f32)0x8000) * M_PI, MTXMODE_APPLY);
        Matrix_RotateZ((sp48.x / (f32)0x8000) * M_PI, MTXMODE_APPLY);
    }

    if ((limbIndex == 8) || (limbIndex == 9) || (limbIndex == 12)) {
        rot->y += Math_SinS(self->unk_21C[limbIndex]) * 200.0f;
        rot->z += Math_CosS(self->unk_23C[limbIndex]) * 200.0f;
    }
...
void func_80A71A64(GlobalContext* globalCtx, s32 limbIndex, Gfx** dList, Vec3s* rot, void* thisx) {
    ...
    if (limbIndex == 7) {
        gSPSegment(POLY_OPA_DISP++, 0x06, globalCtx->objectCtx.status[self->unk_197].segment);
        gSegments[6] = VIRTUAL_TO_PHYSICAL(globalCtx->objectCtx.status[self->unk_197].segment);
    }

    if (((self->actor.params & 0x7F) == 3) && (limbIndex == 8)) {
...
void EnHy_Draw(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (self->actionFunc != func_80A70E34) {
        ...
        Matrix_Translate(self->unk_264.x, self->unk_264.y, self->unk_264.z, MTXMODE_APPLY);
        envColor1 = D_80A722D8[self->actor.params & 0x7F].unk_2;
        envColor2 = D_80A722D8[self->actor.params & 0x7F].unk_7;
        ...
        switch (self->actor.params & 0x7F) {
            ...
            case 20:
                ...
                if (((self->actor.params & 0x7F) == 8) || ((self->actor.params & 0x7F) == 11)) {
                    if ((self->actor.params & 0x7F) == 8) {
                        envColor3 = envColor1;
                    }
                    if ((self->actor.params & 0x7F) == 11) {
        ...
        SkelAnime_DrawFlexOpa(globalCtx, self->skelAnime.skeleton, self->skelAnime.jointTable,
                              self->skelAnime.dListCount, func_80A716B8, func_80A71A64, &self->actor);
    }
