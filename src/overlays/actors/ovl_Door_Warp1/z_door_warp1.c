...
void func_80998E5C(DoorWarp1* this, GlobalContext* globalCtx) {
    ...
    SkelAnime_Init(globalCtx, &this->skelAnime, &D_06002CA8, &D_06001374, 0, 0, 0);
    Animation_ChangeImpl(&this->skelAnime, &D_06001374, 0, Animation_GetLastFrame(&D_06001374),
...
void func_80998FF4(DoorWarp1* this, GlobalContext* globalCtx) {
    ...
    Animation_ChangeImpl(
        ...
        Animation_GetLastFrame(&D_06001374), Animation_GetLastFrame(&D_06001374), 2, 0.0f,
        1);
    this->skelAnime.curFrame = Animation_GetLastFrame(&D_06001374);
    this->unk_1AE = 0x78;
    this->unk_1B0 = 0xE6;
...
void func_8099A508(DoorWarp1* this, GlobalContext* globalCtx) {
    ...
    Animation_ChangeImpl(&this->skelAnime, &D_06001374, 1.0f, Animation_GetLastFrame(&D_06001374),
