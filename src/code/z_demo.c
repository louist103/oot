...
EntranceCutscene sEntranceCutsceneTable[] = {
    ...
    { 0x0538, 2, 0xBB, 0 }, { 0x053C, 2, 0xBC, 0 }, { 0x0540, 2, 0xBD, 0 },
    { 0x0544, 2, 0xBE, 0 },   { 0x0548, 2, 0xBF, 0 }, { 0x054C, 2, 0xAD, 0 },
...
u32 D_8011E304[] = { 0x0200B650, 0x02015600, 0x02014F80, 0x02003F80, 0x02000330, 0 };
