...
void TitleCard_Draw(GlobalContext* globalCtx, TitleCardContext* titleCtx) {
    ...
    if (titleCtx->alpha != 0) {
        ...
        gDPSetPrimColor(OVERLAY_DISP++, 0, 0, 131, 238, 255, (u8)titleCtx->alpha);
        ...
        if (spC8 > 0) {
            ...
            DrawRec(OVERLAY_DISP, sUlx, 30, 300, 30, 131, 238, 255, 255);

            for (i = 0; i < 20; i++) {
                DrawRec(OVERLAY_DISP, Rand_S16Offset(sUlx, 5), 30, 300, 30, 131, 238, 255, 255);
            }
        }
